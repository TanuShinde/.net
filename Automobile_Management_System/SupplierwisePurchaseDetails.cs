...
{
    public partial class SupplierwisePurchaseDetails : Form
    {
        public SupplierwisePurchaseDetails()
        {
            InitializeComponent();
        }
        ...
        private void SUPPLIERNAME_TextChanged(object sender, EventArgs e)
        {
            if (SUPPLIERNAME.Text != "")
            {
                ...
                SqlDataAdapter AD = new SqlDataAdapter("SELECT SUPPLIERNAME FROM VW_PURCHASE WHERE SUPPLIERNAME LIKE'" + SUPPLIERNAME.Text + "%'", CON);
        ...
        {
            SqlDataAdapter AD = new SqlDataAdapter("SELECT * FROM VW_PURCHASE WHERE SUPPLIERNAME='" + SUPPLIERNAME.Text + "'", CON);
            DataSet DS = new DataSet();
            AD.Fill(DS);
