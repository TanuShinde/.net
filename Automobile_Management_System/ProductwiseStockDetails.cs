    ...
    public partial class ProductwiseStockDetails : Form
    {
        ...
        private void PRODUCTNAME_TextChanged(object sender, EventArgs e)
        {
            if (PRODUCTNAME.Text != "")
            {
                ...
                SqlDataAdapter AD = new SqlDataAdapter("SELECT PRODUCTNAME FROM VW_STOCK WHERE PRODUCTNAME LIKE'" + PRODUCTNAME.Text + "%'", CON);
